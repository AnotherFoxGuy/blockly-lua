...
Blockly.ComputerCraft.TERM_FUNCS_ = [{
    ...
    tooltip: 'Write the given string to the screen (terminal or monitor).'
}, {
    funcName: 'clear',
    text: 'clear screen',
    ...
    output: 'Boolean',
    tooltip: 'Return true if the computer supports colour, false otherwise.\n' +
    ...
    output: 'Number', // first output
    multipleOutputs: 2,
    tooltip: 'Get the maximum x-coordinate (width) and y-coordinate (height)\n' +
    ...
    tooltip: 'Scroll the screen (terminal or monitor)\n' +
    ...
    tooltip: 'Redirect terminal output to a monitor or other redirect target.\n' +
    ...
    tooltip: 'Restore the display to the previous target, \n' +
    ...
    tooltip: 'Set the text colour of the terminal.\n' +
    ...
    tooltip: 'Set the background colour of the screen.\n' +
        'This is only available for Advanced Computers\n' +
        'and Advanced Monitors.'
}, {
    ...
    tooltip: 'Set the size of all text on the connected monitor.\n' +
...
Blockly.Blocks['term_set_cursor_blink'] = new Blockly.ComputerCraft.Block(
    'term', Blockly.ComputerCraft.TERM_BLOCK_COLOUR_, {
        ...
        tooltip: 'Enable or disable blinking of the\n' +
